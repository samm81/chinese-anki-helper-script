...
def word_to_ChineseRecognitionOnly(word, tags_string):
  ...
  return ChineseRecognitionOnly(word.simplified, traditional, word.pinyin, word.zhuyin, definition, '', '', '', tags_string)
